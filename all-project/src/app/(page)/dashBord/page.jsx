...
import { HiHome, HiShoppingBag, HiPlus, HiUsers } from "react-icons/hi";
...
import { chartData } from "../../../app/(page)/dashBord/data";
import { chartDataTwo } from "../../../app/(page)/dashBord/dataTwo";
...
export default function Page() {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-12 pt-[150px]">
      {/* Sidebar on the left */}
      <div className="col-span-1 md:col-span-3">
        <Sidebar
          aria-label="Default sidebar"
          className="bg-[#1F2937] text-white shadow-lg"
        >
          <Sidebar.Items>
            <Sidebar.ItemGroup>
              <Sidebar.Item
